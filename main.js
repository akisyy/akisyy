...
function aboutMe() {
    var logo1 = document.getElementById("touxiang");
    logo1.src="img/xianbei.jpg"
    var slogan = document.getElementById("slogan");
    var slogan2 = document.getElementById("slogan2");
    if (i == 0) {
        i = 1;
        slogan.style.height = "100px";
        slogan2.innerHTML = "20岁，是学生。";
    } else {
        i = 0;
        slogan.style.height = "50px";
        slogan2.innerHTML = "这是一个非常粗糙的欢迎页";
    }
}
...
var n=0
function logoChange() {
    var logo2 = document.getElementById("touxiang");
    logo2.src = "img/xianbei2.png"
    if (n == 0) {
        n = 1;
        slogan.style.height = "100px";
        slogan2.innerHTML = "哼哼哼，啊啊啊啊啊啊啊啊啊啊啊啊啊啊！！（发出了奇怪的声音）";
    } else {
        n = 0;
        slogan.style.height = "50px";
        slogan2.innerHTML = "这是一个非常粗糙的欢迎页";
        logo2.src = "img/xianbei.jpg"
    }
}
